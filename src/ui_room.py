...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.room_title_label.sizePolicy().hasHeightForWidth())
        self.room_title_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        ...
        self.user_count_label = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(18)
        self.user_count_label.setFont(font)
        self.user_count_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.user_count_label.setObjectName("user_count_label")
        self.horizontalLayout.addWidget(self.user_count_label)
        ...
        self.participants_tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.participants_tableWidget.setObjectName("participants_tableWidget")
        self.participants_tableWidget.setColumnCount(0)
        self.participants_tableWidget.setRowCount(0)
        self.participants_tableWidget.horizontalHeader().setVisible(False)
        self.participants_tableWidget.verticalHeader().setVisible(False)
        self.verticalLayout_2.addWidget(self.participants_tableWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.user_count_label.setText(_translate("MainWindow", "(n명)"))
